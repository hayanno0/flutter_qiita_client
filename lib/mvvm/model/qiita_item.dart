import 'package:flutter_qiita/mvvm/model/qiita_tag.dart';
import 'package:flutter_qiita/mvvm/model/qiita_user.dart';
...
abstract class QiitaItem with _$QiitaItem {
  ...
  factory QiitaItem.fromJson(Map<String, dynamic> json) => _$QiitaItemFromJson(json);
}